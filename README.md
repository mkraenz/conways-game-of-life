...
```bash
git clone git@github.com:proSingularity/conways-game-of-life.git
```

Install, test, and start the dev server:

```bash
npm run sanity-check
```

With the dev server running, any change to the code (on save) will be reflected on the webpage (the page will reload automatically).
